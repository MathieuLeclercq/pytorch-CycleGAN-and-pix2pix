...
class CycleGANModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        For CycleGAN, in addition to GAN losses, we introduce lambda_A, lambda_B, and lambda_identity for
        ...
        if is_train:
            ...
            parser.add_argument('--lambda_identity', type=float, default=0.5,
                                help='use identity mapping. Setting lambda_identity '
                                     'other than 0 has an effect of scaling the weight of the identity mapping loss. '
                                     'For example, if the weight of the identity loss should be 10 times smaller than '
                                     'the weight of the reconstruction loss, please set lambda_identity = 0.1')
            parser.add_argument('--lambda_shape', type=float, default=1.0, help='weight for shape-consistency loss')
